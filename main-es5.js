...
var HeaderComponent = /** @class */ (function () {
    ...
    HeaderComponent.prototype.verificaSessao = function () {
        return true;
    };
    HeaderComponent.prototype.getReducedName = function () {
        var name = this._userService.carregarNome().split(' ');
...
var MenuComponent = /** @class */ (function () {
    function MenuComponent(_usuarioService) {
    ...
    MenuComponent.prototype.verificaSessao = function () {
        return true;
    };
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.logar = function () {
        ...
        this._userService
            ...
            if (response.status) {
                _this._router.navigate(['/area']);
                _this._userService.notifyLogin();
            }
            else {
                _this.isError = true;
                _this.msgError = 'Login ou senha incorretos';
            }
        });
    };
...
var AuthInterceptor = /** @class */ (function () {
    ...
    AuthInterceptor.prototype.intercept = function (request, next) {
        var userService = this.injector.get(_service_usuario_service__WEBPACK_IMPORTED_MODULE_2__["UsuarioService"]);
...
var LoggedInGuard = /** @class */ (function () {
    function LoggedInGuard(_userService) {
        this._userService = _userService;
    }
    LoggedInGuard.prototype.checkAuthentication = function (path) {
        var loggedIn = this._userService.verifySession();
        if (!loggedIn) {
...
var NotificationService = /** @class */ (function () {
    ...
    NotificationService.prototype.notify = function (obj) {
...
var UsuarioService = /** @class */ (function () {
    function UsuarioService(_http, _router) {
        this._http = _http;
        this._router = _router;
    ...
    UsuarioService.prototype.carregarNome = function () {
        return localStorage.getItem('name');
    };
    UsuarioService.prototype.verifySession = function () {
        return localStorage.getItem('name') != undefined;
    };
    UsuarioService.prototype.save = function (data) {
        return this._http.post(this.webService, data);
    };
    UsuarioService.prototype.getAll = function () {
        return this._http.get(this.webService);
    };
    UsuarioService.prototype.update = function (id, obj) {
    ...
    UsuarioService.prototype.auth = function (obj) {
    ...
    UsuarioService.prototype.notifyLogin = function () {
        this.notifierLogin.emit(true);
    };
    UsuarioService.prototype.sair = function () {
        localStorage.clear();
        this.notifierLogout.emit();
        this._router.navigate(['/']);
    };
    UsuarioService.prototype.handleLogin = function () {
        this._router.navigate(['/']);
    };
    ...
    UsuarioService.prototype.handleForbiden = function () {
...
/* harmony import */ var ngx_currency__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ngx-currency */ "./node_modules/ngx-currency/fesm5/ngx-currency.js");
...
var SnackbarComponent = /** @class */ (function () {
    function SnackbarComponent(_notificationService) {
    ...
    SnackbarComponent.prototype.ngOnInit = function () {
        ...
        this._notificationService
            .notifier
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (obj) {
            console.log(obj);
            _this.tipAlert = obj.status == true ? 'alert-success' : 'alert-danger';
